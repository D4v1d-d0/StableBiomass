...
`StableBiomass` estimates live biomass, mortality biomass, birth biomass,
and prey-size categories from age-structured stable demographic profiles.
It is designed as an ecological and paleobiological extension of
[`StablePopulation`](https://github.com/D4v1d-d0/StablePopulation).
...
The `beta` column can contain a single numeric value in the first row and
